...
export default function ASMController(dataHub) {
    ...
    this.add = function(roleTypeId, name, description, securitySources, isDefaultDomain, callback) {
        const body = {
            roleTypeId,
            name,
            description,
    ...
    this.edit = function(id, roleTypeId, name, description, securitySources, isDefaultDomain, callback) {
        const body = {
            id,
            roleTypeId,
            name,
