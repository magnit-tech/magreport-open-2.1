...
export default function UserController(dataHub){
    ...
    this.setStatus = function (status, userIds, callback){
        const body = {
            status,
            userIds,
        };
    ...
    this.logoff = function (userIds, callback){
        const body = userIds
    ...
    this.getOne = function (userName, domain, callback){
        const body = {userName: userName, domain: domain}
