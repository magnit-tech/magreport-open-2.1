...
export default function FolderContent(props){
    ...
    const itemName =  props.itemsType === FolderItemTypes.report || props.itemsType === FolderItemTypes.reportsDev ? "отчёт"
                    ...
                    : props.itemsType === FolderItemTypes.cubes ? "кубы"
                    : "???";
    ...
    */
    ...
    let items = props.itemsType === FolderItemTypes.report ? props.data.reports :
                ...
                props.itemsType === FolderItemTypes.cubes ? props.data :
                [];
            ...
            gridItems.push(
                ...
                >
                    <ItemCard
                        ...
                        onContextMenu={handleContextClickObject}
                        onJobAddComment={props.onJobAddComment}    
                    />
                </Grid>
    ...
    return(
        <div className={classes.relative}>
            ...
            {   (props.itemsType === FolderItemTypes.userJobs || props.itemsType === FolderItemTypes.job || props.itemsType === FolderItemTypes.cubes) && <RefreshButton onRefreshClick={props.onRefreshClick} />}
