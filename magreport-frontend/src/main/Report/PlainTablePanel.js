...
export default function PlainTablePanel(props){
    ...
    const excelRowLimit = props.excelRowLimit;
    ...
    function TablePaginationActions(props) {
        ...
        return (
            <div className={classes.pagination} display="block">
                ...
                <Tooltip title= {rowCount >= excelRowLimit ? "Экспорт Excel: превышен лимит кол-ва строк для выгрузки": "Экспорт Excel"}>
                    <span>
                        <IconButton className={classes.iconButton}
                            size="small"
                            aria-label="export"
                ...
                </Tooltip>
                {
                    ...
                    <ReportTemplatesList 
                        ...
                        isDisabled={exportInProcess || rowCount >= excelRowLimit}
