...
export default function OlapConfig(config){
    ...
    */
    ...
    this.saveNewConfig = (obj, reportId, callback) => {
        ...
        const { name, description, saveFor, isShare, isDefault } = obj

        let payloadData = {}

        if (saveFor === 'job' || saveFor === 'report') {
            payloadData = {
                ...this.configData,
                'isShare': isShare,
                'isDefault': isDefault,
	...
	this.saveExistingConfig = (obj, reportId, callback) => {
        ...
        const { name, description, saveFor, isShare, isDefault, olapConfigId = null, reportOlapConfigId = null } = obj
