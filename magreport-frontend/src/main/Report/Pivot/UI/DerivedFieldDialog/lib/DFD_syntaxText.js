...
export const DFD_languageConstructs = [
	{
		name: 'выражения',
		descr: ` -- часть формулы, которая может быть вычислена как
