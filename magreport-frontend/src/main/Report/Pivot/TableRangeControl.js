...
export default function TableRangeControl(props) {
    ...
    }, [props.position, props.total, props.count]); // eslint-disable-line
    ...
    return (
        ...
        >  
            <IconButton 
                ...
                disabled = {props.total < Math.min(props.position + props.count, props.total) || props.position === 0} 
            >
            ...
            <IconButton 
                ...
                size = 'small'
                onClick = {() => {handleArrowClick(1)}} 
                disabled = {props.total <= Math.min(props.position + props.count, props.total) || props.position===props.total}
            >
