...
import static ru.magnit.magreportbackend.domain.asm.ExternalAuthSourceFieldTypeEnum.DOMAIN_NAME_FIELD;
...
public class ExternalAuthSourceView {
    ...
    public ExternalAuthSourceFieldView getDomainNameField() {
        return fields.get(DOMAIN_NAME_FIELD).get(0);
    }
