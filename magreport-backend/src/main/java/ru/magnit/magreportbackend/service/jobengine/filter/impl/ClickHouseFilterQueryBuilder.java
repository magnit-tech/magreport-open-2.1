...
public class ClickHouseFilterQueryBuilder implements FilterQueryBuilder {

    private final TemplateParserService templateParserService;

    @Value("${magreport.query-templates.filter.value-list.click-house}")
    private String valueListTemplatePath;

    @Value("${magreport.query-templates.filter.child-nodes.click-house}")
    private String childNodesTemplatePath;

    @Value("${magreport.query-templates.filter.fields.click-house}")
