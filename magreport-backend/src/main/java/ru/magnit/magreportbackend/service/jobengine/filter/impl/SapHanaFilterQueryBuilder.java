...
public class SapHanaFilterQueryBuilder  implements FilterQueryBuilder {

    private final TemplateParserService templateParserService;

    @Value("${magreport.query-templates.filter.value-list.sap-hana}")
    private String valueListTemplatePath;

    @Value("${magreport.query-templates.filter.child-nodes.sap-hana}")
    private String childNodesTemplatePath;

    @Value("${magreport.query-templates.filter.fields.sap-hana}")
