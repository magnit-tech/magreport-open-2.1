...
public class RoundExpression extends ParameterizedExpression {
    private final Pair<String, DataTypeEnum> result = new Pair<>(null, DataTypeEnum.INTEGER);

    public RoundExpression(FieldExpressionResponse fieldExpression, ExpressionCreationContext context) {
    ...
    public Pair<String, DataTypeEnum> calculate(int rowNumber) {
        ...
        if (firstValue.getR() == DataTypeEnum.DOUBLE) {
            ...
            result.setL(String.valueOf(Math.round(value)));
        } else {
