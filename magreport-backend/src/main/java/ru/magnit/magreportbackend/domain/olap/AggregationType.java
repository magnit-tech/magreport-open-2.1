...
public enum AggregationType {
    ...
    public MetricsFunction getMetricsFunction(DataTypeEnum dataType, Set<Triple<Integer, Integer, String>> cdm) {
        return switch (this) {
            case COUNT -> new CountFunction();
            case COUNT_DISTINCT -> new CountDistinctFunction(cdm);
