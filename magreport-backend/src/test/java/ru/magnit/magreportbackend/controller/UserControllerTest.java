...
import static ru.magnit.magreportbackend.controller.UserController.USERS_GET_ALL_STATUSES;
import static ru.magnit.magreportbackend.controller.UserController.USERS_GET_ONE;
import static ru.magnit.magreportbackend.controller.UserController.USERS_LOGOFF;
import static ru.magnit.magreportbackend.controller.UserController.USERS_SET_STATUS;
...
class UserControllerTest {
    ...
    void getWhoAmI() throws Exception {
        ...
        when(service.getCurrentUserName()).thenReturn(new UserNameResponse(NAME, DOMAIN));
        when(service.getUserResponse(any())).thenReturn(getUserResponse());
