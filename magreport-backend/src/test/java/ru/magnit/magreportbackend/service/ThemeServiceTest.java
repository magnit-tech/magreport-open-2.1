...
class ThemeServiceTest {
    ...
    void getAllUserThemes() {
        ...
        when(userDomainService.getUserResponse(any(), any())).thenReturn(new UserResponse().setId(ID));
        ...
        verify(userDomainService).getUserResponse(any(), any());
    ...
    private ThemeResponse getThemeResponse() {
        return new ThemeResponse()
                ...
                .setUser(new UserShortResponse(USER_ID, NAME, "DOMAIN"))
