...
class DataSetDomainServiceTest {
    ...
    @Mock
    private DataSetDataTypeRepository dataTypeRepository;
    ...
    void getDataSetDataTypes() {
        when(dataTypeRepository.findAll()).thenReturn(Collections.singletonList(new DataType()));
        ...
        verifyNoMoreInteractions(dataTypeRepository);
