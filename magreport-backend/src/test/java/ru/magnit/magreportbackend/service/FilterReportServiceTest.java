...
class FilterReportServiceTest {
    ...
    void getFilters() {
        ...
        assertEquals(BinaryBooleanOperations.AND, result.operationType());
    ...
    void addFilters() {
       ...
       var response = service.addFilters(getSource());
        ...
        assertEquals(BinaryBooleanOperations.AND, response.operationType());
    ...
    void FilterReportChildNodesResponse() {
        ...
        when(securityFilterDomainService.getEffectiveSettingsForFilter(any(), any())).thenReturn(Collections.emptyList());
        ...
        verify(securityFilterDomainService).getEffectiveSettingsForFilter(any(), any());
