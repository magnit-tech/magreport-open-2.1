...
class WeekFromDateExpressionTest {
    @Test
    void weekFromDateTest() {
        final var sourceExpression = new FieldExpressionResponse()
            .setType(Expressions.WEEK_FROM_DATE)
        ...
        assertEquals(String.valueOf(LocalDate.now().get(WeekFields.ISO.weekOfYear())), expressionResult.getL());
