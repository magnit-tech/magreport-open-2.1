...
class DayFromDateExpressionTest {
    @Test
    void dayFromDateTest() {
        final var sourceExpression = new FieldExpressionResponse()
            .setType(Expressions.DAY_FROM_DATE)
        ...
        assertEquals(String.valueOf(LocalDate.now().getDayOfMonth()), expressionResult.getL());
