...
class YearFromDateExpressionTest {
    @Test
    void yearFromDateTest() {
        final var sourceExpression = new FieldExpressionResponse()
            .setType(Expressions.YEAR_FROM_DATE)
        ...
        assertEquals(String.valueOf(LocalDate.now().getYear()), expressionResult.getL());
